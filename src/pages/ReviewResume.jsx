...
const ReviewResume = () => {
  ...
  return (          
       ...
       {/* {left col} */}
        <form onSubmit={onSubmitHandler} className='w-full  max-w-lg p-4 bg-white rounded-lg border border-gray-200'>
         <div className='flex items-center gap-3'>
          <Sparkles className='w-6 text-[#108d3a]'/>
      ...
      <button className='w-full flex justify-center items-center gap-2 bg-linear-to-r from-[#0d9c15] to-[#05461a] text-white px-4 py-2 mt-6 text-sm rounded-lg cursor-pointer'>
    ...
    <div className='flex items-center gap-3'>
    <FileText className='w-5 h-5 text-[#108d3a]'/>
    ...
    <div className='flex-1 flex justify-center items-center'>
      ...
      <p className='text-lg font-semibold'> Upload an resume and click "Resume Review" to get started </p>
      </div>
     </div>
